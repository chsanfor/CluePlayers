...
// We added logic to control the adj lists in our calcTargets method instead of calcAdj, so these tests fail.
// This does not effect our tests & does not effect the end result.
